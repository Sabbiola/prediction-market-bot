...
- profilo config staging first-class (`config/app.staging.yaml`) con check startup dedicati
...
- deploy staging usa `config/app.staging.yaml` come baseline operativa
