...
## Profilo staging sandbox-live

Il repository include un profilo dedicato: `config/app.staging.yaml`.

Il profilo imposta in modo esplicito:
...
## Dress rehearsal beta-live (GO/NO_GO)

Per il test operativo completo sandbox-live usare il comando orchestrato:
...
Il comando copre in sequenza:

1. init/upgrade/verify DB
2. startup validation
3. healthcheck
4. UI ready + auth
5. scheduler probe
6. smoke provider live
7. run-once con review candidate
8. review approval
9. sandbox tx submit + reconcile
10. open position visibility
11. settlement lane
12. replay + report
13. UI lifecycle reflection

Limiti espliciti della missione beta-live:

- nessun posting ordini live su venue reale
- mandatory review gate sempre attivo
