...
class FeatureDatasetLayout:
    ...
    def from_base(
        ...
        *,
        ...
        feature_root = dataset_root / "derived" / "feature_store" / schema_version
        return cls(
            dataset_id=dataset_id,
            schema_version=schema_version,
            dataset_root=dataset_root,
            feature_root=feature_root,
            rows_path=feature_root / "feature_rows.jsonl",
            schema_path=feature_root / "feature_schema.json",
...
class FeatureDatasetStorage:
    def __init__(self, layout: FeatureDatasetLayout) -> None:
        self.layout = layout
