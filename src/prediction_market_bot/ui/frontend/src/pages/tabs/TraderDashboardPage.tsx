...
const MODELS: ModelDef[] = [
  ...
  { key: 'g', short: 'G', label: 'Model G', family: 'RSI mean-reversion + ML filter · BTC HL 15x · 8h hold (profit ~30%/y)', endpoint: '/api/trader/live/g', historyEndpoint: '/api/trader/history/g', breakEven: 0.46, venue: 'hyperliquid' },
  { key: 'h', short: 'H', label: 'Model H', family: 'RSI mean-reversion · SOL HL 15x · 16h hold (backtest WR 70%)',           endpoint: '/api/trader/live/h', historyEndpoint: '/api/trader/history/h', breakEven: 0.40, venue: 'hyperliquid' },
]
